...
#define STRING_CONFIG_H_AUTHOR "(REK, JVBot)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "JVBot"
...
#define X_MIN_ENDSTOP_INVERTING true        // Set to true to invert the logic of the endstop. REK
#define Y_MIN_ENDSTOP_INVERTING true        // Set to true to invert the logic of the endstop. REK
#define Z_MIN_ENDSTOP_INVERTING true        // Set to true to invert the logic of the endstop. REK
...
// #define E0_DRIVER_TYPE TMC2209 REK
...
#define X_BED_SIZE 58  // REK
#define Y_BED_SIZE 170 // REK
